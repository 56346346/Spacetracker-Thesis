...
namespace Autodesk.Revit.DB
{
    ...
    {
        public FailureSeverity GetSeverity() => FailureSeverity.None;
    }

    public class FailuresAccessor
    {
        public IEnumerable<FailureMessageAccessor> GetFailureMessages() => System.Array.Empty<FailureMessageAccessor>();
        public void DeleteWarning(FailureMessageAccessor message) { }
    }
